...
st.title("Submit Counter-Examples")

st.write("""To submit counter-examples to the conjectures generated by TxGraffiti, and thus, better the conjectures made by
        TxGraffiti, please email edgelists to rrd6@rice.edu.""")